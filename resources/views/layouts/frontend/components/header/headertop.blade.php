<div id="header_top" class="header_top">
    ...
    <div class="hright">
       {{-- <div class="dropdown">
    <a href="javascript:void(0)" class="nav-link icon theme_btn"><i class="fa fa-paint-brush" data-toggle="tooltip" data-placement="right" title="" data-original-title="Themes" aria-describedby="tooltip435546"></i></a>
    <a href="javascript:void(0)" class="nav-link icon settingbar"><i class="fa fa-gear fa-spin" data-toggle="tooltip" data-placement="right" title="" data-original-title="Settings"></i></a>
